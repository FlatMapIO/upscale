...
export class AvatarVisualization {
	...
	private currentMotionType = 4 // Default motion type
	private targetMotionType = 9 // Initialize with the same value as currentMotionType
	private transitioning = false
	private motionBlendFactor: { value: number } = { value: 0.0 }
	private lowRangeStart = 0
	private lowRangeEnd = 0
	private midRangeStart = 0
	private midRangeEnd = 0
	private highRangeStart = 0
	private highRangeEnd = 0
	...
	private static TRIANGLE_WAVE_SEGMENTS = 50
	...
	private setupParticleSystem = () => {
		...
		geometry.setAttribute('birthTime', new THREE.BufferAttribute(birthTimes, 1)) // Add birth times as an attribute
